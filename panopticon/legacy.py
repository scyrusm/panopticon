...
def get_gsea_with_selenium(diffex, email='s'):
    ...
    for key in diffex.keys():
        ...
        elem.send_keys('\n'.join(
            diffex[key].query('MeanExpr1 > MeanExpr2')['gene'][0:200].values))
        ...
        select = Select(
            driver.find_element_by_xpath(
                '/html/body/div[2]/div[4]/div/table/tbody/tr/td[3]/table/tbody/tr/td[2]/form/table/tbody/tr[30]/td/p[1]/nobr/select'
            ))
        ...
        while True:
            try:
                ...
                footersize += 1
        genelisthits = pd.read_table("{}/overlap.tsv".format(download_folder),
                                     skiprows=10,
